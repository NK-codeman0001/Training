...
ActiveRecord::Schema[7.0].define(version: 2023_04_20_091948) do
  ...
  create_table "students", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["monitor_id"], name: "index_students_on_monitor_id"
  end
  ...
  add_foreign_key "students", "students", column: "monitor_id"
end
